...
@Component({
  selector: 'app-silsi-pasta',
  templateUrl: './silsi-pasta.component.html',
  styleUrls: ['./silsi-pasta.component.sass']
})
export class SilsiPastaComponent implements OnInit {
  isMobile: boolean = false
  getScreenWidth!: number;
  AllRecipes: IRecipes = AllRecipes

  recipeName: string = "Silsi Pasta" // Update this when creating a new recipe
