...
@Component({
  selector: 'app-crack-noodles',
  templateUrl: './crack-noodles.component.html',
  styleUrls: ['./crack-noodles.component.sass']
})
export class CrackNoodlesComponent implements OnInit {
  isMobile: boolean = false
  getScreenWidth!: number;
  AllRecipes: IRecipes = AllRecipes

  recipeName: string = "Crack Noodles" // Update this when creating a new recipe
